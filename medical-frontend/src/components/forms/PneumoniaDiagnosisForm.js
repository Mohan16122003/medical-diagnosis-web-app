...
const PneumoniaDiagnosisForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://127.0.0.1:5000/predict/pneumonia", formData, {
    ...
    return (
        <div className="form-container">
            <h2 className="form-title">Pneumonia Detection</h2>
...
export default PneumoniaDiagnosisForm;
